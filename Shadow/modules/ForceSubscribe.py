...
_Note: Only creator of the group can setup me and I will not allow force subscribe again if not done so._
...
<i>Note: `/forcesub` is an alias of `/forcesubscribe`</i>
