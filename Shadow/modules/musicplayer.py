...
╔🟡For Group Music Play🟡 
╠ `/play [song name]`: Play song using youtube music
╠ `/play [yt url]`: Play the given yt url
╠ `/dplay [song name]`: Play song via deezer
╠ `/splay [song name]`: Play song via jio saavn
...
⚠️ Note: `channel` can also be used instead of `c` in commands 
 eg:-`/cplay` = `/channelplay`
